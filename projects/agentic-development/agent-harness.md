...
toc: true
permalink: /projects/agentic-development/agent-harness/
---
...
> How can we optimize agent autonomy while maintaining human visibility and control ΓÇö closer to human-on-the-loop than human-in-the-loop?
...
### V0 ΓÇö Manual ChatGPT-Assisted Development
...
### V1 ΓÇö Multi-Agent Codex Development
...
### V2 ΓÇö Simplified LEFT / RIGHT Developer Instances
...
### V3 ΓÇö LogQ Event Stream and Agent Observability
...
V2's LEFT and RIGHT instances seemed like a good optimization on cost. I rarely ran up against token limits, and there was still meaningful design and project-management work I could do in the 10ΓÇô15 minutes between agent runs.
